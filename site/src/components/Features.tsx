    ...
    <section id="features" className="px-6 py-20 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl text-gray-600 text-center mb-16 max-w-3xl mx-auto">
          A functional programming library designed for TypeScript developers
          who value type safety and composition
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-colors">
            ...
            <p className="text-gray-600">
              Familiar constructor functions with method chaining. Works like
              Scala's collections API.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-colors">
            ...
            <p className="text-gray-600">
              Do-notation is 12x faster for List comprehensions compared to
              traditional flatMap chains.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-colors">
            ...
            <p className="text-gray-600">
              All types implement the same hierarchy of interfaces. Learn once,
              use everywhere.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-colors">
            ...
            <p className="text-gray-600">
              Import only what you need. Optimized for minimal bundle size with
              selective imports.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              See at a glance which functional programming interfaces are
              supported by each data structure
            </p>
            <a
              href="/feature-matrix"
