...
import { TypedError, type ErrorCode, type ErrorMessage, type ErrorStatus, type TypedErrorContext } from "@/error/typed/TypedError"
...
describe("TypedError", () => {
  ...
  describe("error properties", () => {
    ...
    it("should include trace ID when provided", () => {
      ...
      const errorWithTrace = TypedError("NETWORK_ERROR", 
